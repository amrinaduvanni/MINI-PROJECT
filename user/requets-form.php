...
<html lang="en">
<head>
  <title>AC Repairing System :: Request Form</title>
  <!-- Bootstrap core CSS -->
...
<?php include_once('includes/sidebar.php');?>
            ...
            <div class="form-panel">
              <form role="form" class="form-horizontal style-form" method="post">
                ...
                <div class="form-group has-success">
                  <label class="col-lg-2 control-label">AC Type</label>
                  <div class="col-lg-10">
 ...
 ?>
                ...
                <div class="form-group has-success">
                  <label class="col-lg-2 control-label">AC Capacity</label>
                  <div class="col-lg-10">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="col-lg-10">
                   <select type="text" class="form-control" name="acproblem" value="" required='true'>
                    ...
                    <option value="Faulty AC">Faulty AC</option>
