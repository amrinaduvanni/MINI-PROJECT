...
<html lang="en">
<head>
<title>AC Repairing System | Home Page</title>
 ...
 ?>
			...
			<div class="header">
				...
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">AC Repairing System</a></h1>
				</div>
							...
							<ul class="slides">
								<li>
									<div class="agileits_w3layouts_banner_info">
										<h3>AC Repairing & Services </h3>
										<p> Helps customers to provide repair, maintenance, and installation services for both Window and Split ACs.
										</p>
									</div>
								</li>
								<li>
									<div class="agileits_w3layouts_banner_info">
										...
										<p>Book your AC repair and maintenance services conveniently from your homes and Technicians
										will visit your home to fix the AC.</p>
									</div>
								</li>
								<li>
									<div class="agileits_w3layouts_banner_info">
										<h3>Tools & Specialist Equipment</h3>
										<p>Ensure timely and high-quality repair services by qualified technicians.</p>
									</div>
								</li>
							</ul>
						</div>
...
<div class="footer">
		<div class="container">
		<h2 class="wthree_head">AC Repairing System</h2>
				<p class="agileits_w3layouts_para w3_agile_para">Air conditioners are essential for keeping spaces cool, improving comfort, and protecting health and electronics, especially in hot weather.</p>
